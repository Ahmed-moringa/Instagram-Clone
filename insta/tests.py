...
class TestPost(TestCase):
    def setUp(self):
        self.profile_test = Profile(name='charles', user=User(username='ahmed'))
        self.profile_test.save()
        self.image_test = Post(image='default.png', name='test', caption='default caption test', user=self.profile_test)
